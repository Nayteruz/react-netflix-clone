...
const Auth = () => {
    ...
    return (
        <div
            className="relative h-full min-h-[100vh] w-full bg-[url('/images/hero2.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
                ...
                <div className="flex justify-center">
                    <div
                        ...
                        <p className="text-neutral-500 mt-12">
                            {variant === 'login' ? 'First time netflix?' : 'Already have an account?'}
